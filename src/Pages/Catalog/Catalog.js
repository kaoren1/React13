...
class Catalog extends Component {
  ...
  handleDropdownClick = () => {
  const dropdown = document.querySelector('.category-checkbox-container');
    ...
    return (
      ...
      >
        <div className="category-filters">
          <div className="category-checkbox-container" onClick={this.handleDropdownClick}>
            {['Игровые', 'Компактные', 'Ноутбуки', 'Мониторы', 'Мыши', 'Наушники'].map((category) => (
